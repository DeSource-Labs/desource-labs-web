import type { SocialMediaItem, SocialMediaKey, Product } from '../types';
...
export const Projects: Product[] = [
  {
    ...
    tags: ['Front-end', 'Blockchain', 'Launchpad', 'AI'],
    shadowColor: 'lime',
    status: 'delivered',
    impact: 'Real-time token launches',
    client: 'Vocal Fun',
  },
  {
    id: 1,
  ...
  },
  {
    ...
    shadowColor: 'pink',
    status: 'delivered',
    impact: 'Multi-chain integration',
    client: 'MiniVerse',
  },
  {
    id: 3,
    title: 'NFT Marketplace',
    desc: 'Full-stack NFT marketplace trusted by collectors, featuring sub-second load times and seamless UX',
    tags: ['NFT', 'Marketplace', 'Design'],
    logoId: 2,
    shadowColor: 'white',
    status: 'delivered',
    impact: 'Unique UX for collectors',
    client: 'Trait',
  },
  {
    id: 9,
  ...
  },
  {
    id: 6,
    title: 'Education Hub',
    desc: 'Web3 learning platform delivering courses worldwide with token-gated access',
  ...
  },
  {
    ...
    status: 'delivered',
    client: 'MiniVerse',
    url: 'https://miniverse-site.vercel.app'
  },
  {
    id: 2,
    ...
    shadowColor: 'white',
    status: 'delivered',
    impact: '2x performance boost',
    client: 'Trait',
  },
  {
    id: 10,
    title: 'Mem0 Browser Extension',
  ...
  },
  {
    ...
    desc: 'Ultra-lightweight open-source library for phone number formatting, supporting all countries with zero dependencies',
    tags: ['Library', 'Front-end', 'Open Source'],
    status: 'open-source',
    url: 'https://github.com/DeSource-Labs/phone-mask',
